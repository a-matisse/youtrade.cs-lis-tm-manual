...
будет считаться выгодной. **minProfit** зависит от разницы между покупной ценой и ценой продажи с учетом всех комиссий.
Чем выше значение, тем выше потенциальная прибыль, но тем меньше предложений бот будет
рассматривать.
